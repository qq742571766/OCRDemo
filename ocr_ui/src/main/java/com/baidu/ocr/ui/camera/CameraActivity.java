...
public class CameraActivity extends Activity {
    ...
    private PermissionCallback permissionCallback = this::onRequestPermission;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        confirmResultContainer.findViewById(R.id.confirm_button).setOnClickListener
                (confirmButtonOnClickListener);
        confirmResultContainer.findViewById(R.id.cancel_button).setOnClickListener
                (confirmCancelButtonOnClickListener);
        ...
        cropContainer.findViewById(R.id.confirm_button).setOnClickListener
                (cropConfirmButtonListener);
    ...
    private void initParams() {
        ...
        if (maskType == MaskView.MASK_TYPE_ID_CARD_FRONT || maskType == MaskView
    ...
    private void initNative(final String token) {
        CameraNativeHelper.init(CameraActivity.this, token, (errorCode, e) -> cameraView
                .setInitNativeStatus(errorCode));
    }
    ...
    private CameraView.OnTakePictureCallback autoTakePictureCallback = new CameraView
    ...
    private CameraView.OnTakePictureCallback takePictureCallback = new CameraView
            .OnTakePictureCallback() {
        @Override
        public void onPictureTaken(final Bitmap bitmap) {
            handler.post(() -> {
